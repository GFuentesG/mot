...
import { idlFactory } from './to-do1-backend.did.js';
export { idlFactory } from './to-do1-backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TO_DO1_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./to-do1-backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the to-do1-backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./to-do1-backend.did.js")._SERVICE>}
 */
export const to_do1_backend = createActor(canisterId);
